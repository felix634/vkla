...
// megjelenése minden korosztályhoz"). Az időpontok a CMS-ből jönnek később.
  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <GroupFilter filter={filter} setFilter={setFilter} options={GROUP_NAMES} />
        <SoonBadge label="CMS időpontok — hamarosan" />
      </div>
